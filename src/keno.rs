...
pub const L_P1:  [u64;  2] = [7000, 18600];
pub const L_P2:  [u64;  3] = [0, 19995, 38300];
pub const L_P3:  [u64;  4] = [0, 10996, 13900, 260100];
pub const L_P4:  [u64;  5] = [0, 0, 21988, 79200, 901000];
pub const L_P5:  [u64;  6] = [0, 0, 14993, 42000, 131200, 3000000];
pub const L_P6:  [u64;  7] = [0, 0, 10997, 20000, 62000, 1000000, 7000000];
pub const L_P7:  [u64;  8] = [0, 0, 10998, 16000, 35000, 150000, 2270000, 7000000];
pub const L_P8:  [u64;  9] = [0, 0, 11000, 14992, 20000, 55100, 390000, 1000000, 8000000];
pub const L_P9:  [u64; 10] = [0, 0, 10993, 13000, 17000, 25000, 73500, 500000, 2500000, 10000000];
pub const L_P10: [u64; 11] = [0, 0, 10993, 12000, 13000, 18600, 35100, 130000, 500000, 2500000, 10000000];

// ── Medium risk multiplier tables (x10000) ──────────────────────

pub const M_P1:  [u64;  2] = [4000, 27600];
pub const M_P2:  [u64;  3] = [0, 18105, 50900];
pub const M_P3:  [u64;  4] = [0, 0, 28000, 500100];
pub const M_P4:  [u64;  5] = [0, 0, 17000, 99939, 1010500];
pub const M_P5:  [u64;  6] = [0, 0, 13992, 40000, 140800, 3900000];
pub const M_P6:  [u64;  7] = [0, 0, 0, 29985, 90000, 1809300, 7100000];
pub const M_P7:  [u64;  8] = [0, 0, 0, 19991, 70000, 300000, 4016000, 8000000];
pub const M_P8:  [u64;  9] = [0, 0, 0, 19991, 40000, 110000, 678000, 4000000, 9000000];
pub const M_P9:  [u64; 10] = [0, 0, 0, 19992, 25000, 50000, 152500, 1000000, 5000000, 10000000];
pub const M_P10: [u64; 11] = [0, 0, 0, 15992, 20000, 40000, 70000, 268000, 1000000, 5000000, 10000000];

// ── High risk multiplier tables (x10000) ────────────────────────

pub const H_P1:  [u64;  2] = [0, 39600];
pub const H_P2:  [u64;  3] = [0, 0, 171600];
pub const H_P3:  [u64;  4] = [0, 0, 0, 815100];
pub const H_P4:  [u64;  5] = [0, 0, 0, 100000, 2594100];
pub const H_P5:  [u64;  6] = [0, 0, 0, 45000, 479955, 4530000];
pub const H_P6:  [u64;  7] = [0, 0, 0, 0, 110000, 3500061, 7100000];
pub const H_P7:  [u64;  8] = [0, 0, 0, 0, 70000, 900649, 4000000, 8000000];
pub const H_P8:  [u64;  9] = [0, 0, 0, 0, 49976, 200000, 2700000, 6130000, 9000000];
pub const H_P9:  [u64; 10] = [0, 0, 0, 0, 39980, 110000, 560000, 5030000, 8000000, 10000000];
pub const H_P10: [u64; 11] = [0, 0, 0, 0, 34986, 80000, 130000, 632000, 5000000, 8000000, 10000000];
